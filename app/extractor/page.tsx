  ...
  async function processFiles(files: FileList | File[]) {
    ...
    for (let i = 0; i < fileArr.length; i++) {
      ...
      try {
        ...
        // TEMP DEBUG: log the raw OCR output so you can see exactly what
        // Tesseract read from this image before the regex filters it.
        // Remove this once extraction is confirmed working reliably.
        console.log(`[OCR raw text] ${file.name}:\n${text}`);
